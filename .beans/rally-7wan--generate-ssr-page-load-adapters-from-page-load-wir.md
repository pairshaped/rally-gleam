...
Scoreboard app_ssr now provides only load_context for public SSR loads. Route-to-message selection remains app-owned for now, including Home -> PublicGamesLoad, because that is product behavior rather than file-path metadata.
